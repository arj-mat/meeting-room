...
- [Projeto de Meeting Room](#projeto-de-meeting-room)
  ...
  * [Backend](#backend)
      ...
      - [Destaques](#destaques)
        * [Autenticação com OAuth do Discord](#autenticação-com-oauth-do-discord)
        * [Sincronização de conteúdo não armazenado no servidor](#sincronização-de-conteúdo-não-armazenado-no-servidor)
